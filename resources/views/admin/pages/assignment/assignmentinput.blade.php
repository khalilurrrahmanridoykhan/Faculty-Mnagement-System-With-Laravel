                                ...
                                <select class="form-control" name="Section" id="Section">
                                    @if (!empty($section))
                                        @foreach ($section as $sections)
                                            <option value="{{ $sections->sections_id }}">{{ $sections->Section_no }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status == 0) {
                                    ...
                                    $("#just-validation-sectioin").append(validationhtml);
                                    $('#assignmentsubmitbutton').removeAttr("type").attr("type",
                                        "submit");
